...
import Pom_Web.Pom_Signin1;

public class mini extends Mini_Pro_Base {
		...
		public static void main(String[] args) throws Throwable  {
			...
			Pom_Signin1 a = new Pom_Signin1(driver);
			...
			//button[@type='submit'])[2]
					...
					elementClick(ab);
							...
							Thread.sleep(2000);
									...
									screenShot("C:\\Users\\Humesh\\eclipse-workspace\\Selenium\\Screenshot\\Snap1.png");
